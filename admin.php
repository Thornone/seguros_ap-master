...
if ( isset($_GET['m']) ){
	switch($_GET['m']) {
		...
		break;
				case "vencimientos":
			$paginaPHP = "php/vencimientos.php";
		break;
				case "vencimientosAgentes":
			$paginaPHP = "php/vencimientosAgentes.php";
		break;
		case "pagos":
			$paginaPHP = "php/pagos.php";
		break;
		case "modificarPagos":
			$paginaPHP = "php/modificarPagos.php";
		break;
	}
} else {
								...
								<nav class="nav-primary hidden-xs">
									<ul class="nav">
										...
										<li class="">
											...
											<li class="">
											<a href="#webpage" class=""><i class="fa fa-angle-right icon"></i> <span class="pull-right"> <i class="fa fa-angle-down text"></i> <i class="fa fa-angle-up text-active"></i> </span> <span>Mod Vencimientos</span> </a>
											<ul class="nav lt" style="display: none;">
											<li> <a href="admin.php?m=vencimientos"> <i class="fa fa-angle-right"></i> <span>Vencimientos</span> </a> </li>
											<li> <a href="admin.php?m=vencimientosAgentes"> <i class="fa fa-angle-right"></i> <span>Vencimientos Agente</span> </a> </li>
											</ul>
										</li>
											<li class="">
											<a href="#webpage" class=""><i class="fa fa-angle-right icon"></i> <span class="pull-right"> <i class="fa fa-angle-down text"></i> <i class="fa fa-angle-up text-active"></i> </span> <span>Modulo Pagos</span> </a>
											<ul class="nav lt" style="display: none;">
												<li> <a href="admin.php?m=pagos"> <i class="fa fa-angle-right"></i> <span>Pagos</span> </a> </li>
												<li> <a href="admin.php?m=modificarPagos"> <i class="fa fa-angle-right"></i> <span>Modificar Pagos</span> </a> </li>
											</ul>
										</li>
									</ul>
								</nav>
